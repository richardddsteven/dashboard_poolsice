...
<div class="page-header">
    <div>
        <h1 class="page-title">Tambah Zona</h1>
        <p class="page-subtitle">Buat zona wilayah baru</p>
    </div>
    ...
    <form method="POST" action="{{ route('zones.store') }}">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            <div>
                ...
                <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: Zona A" required>
            </div>
            <div>
                ...
                <p class="zone-help-text">Klik pada peta untuk menentukan lokasi zona. Anda juga dapat drag marker untuk menyesuaikan titik.</p>
            </div>
            <div class="zone-coordinates-grid">
                <div>
                    ...
                    <input type="number" step="0.0000001" id="latitude" name="latitude" class="form-control" value="{{ old('latitude', -8.6704589) }}" required>
                </div>
                <div>
                    ...
                    <input type="number" step="0.0000001" id="longitude" name="longitude" class="form-control" value="{{ old('longitude', 115.2126293) }}" required>
                </div>
            </div>
