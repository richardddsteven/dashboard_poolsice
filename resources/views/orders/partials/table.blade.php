                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="display: flex; gap: 8px; justify-content: center;">
                            <form action="{{ route('orders.update', $order) }}" method="POST" onsubmit="showConfirmModal(event, 'Terima pesanan ini?', this, false)">
                                @csrf
                                @method('PUT')
                            ...
                            <form action="{{ route('orders.update', $order) }}" method="POST" onsubmit="showConfirmModal(event, 'Tolak pesanan ini?', this, true)">
                                @csrf
                                @method('PUT')
